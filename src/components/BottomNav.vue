...
.nav-content {
  ...
  align-items: center;
  height: 49px; /* Standard iOS Tab Bar height (looks like ~49-50px) */
  padding: 0;
}
...
.nav-item {
  ...
  color: #999; /* Unselected state gray */
  ...
  .nav-label {
    ...
    font-weight: 500;
    margin-top: 3px;
    opacity: 1; /* Always visible for iOS style */
  }
  
  &.active {
    color: #fa233b; /* Apple Music Red-ish/Brand Color */
